      ...
      <div className="label-sheet mx-auto flex w-full max-w-5xl flex-wrap content-start gap-2 p-4 sm:p-6">
        {Array.from({ length: copies }, (_, index) => (
          ...
          >
            ...
            {/*
              Разметка SVG сгенерирована сервером из внутреннего кода (bwip-js +
              экранированный текст), пользовательского ввода в ней нет.
              Инлайновый вектор, а не <img>: так печать гарантированно векторная.
            */}
            <div
