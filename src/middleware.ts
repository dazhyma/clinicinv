 ...
 *
 * `img-src data: blob:` — инлайновая графика штрихкода.
 */
...
export const config = {
  matcher: [
     ...
     *
     * Все API с данными инвентаря сюда ПОПАДАЮТ намеренно: cookie в middleware
     * лишь первый рубеж, а route handlers повторно проверяют сессию.
     */
    /*
